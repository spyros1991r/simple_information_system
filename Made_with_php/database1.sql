...
-- Χρόνος δημιουργίας: 09 Μάη 2015 στις 14:48:39
...
`id` int(11) NOT NULL,
  `name_of_product` varchar(11) NOT NULL,
  `sales_of_product` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
...
INSERT INTO `statistics` (`id`, `name_of_product`, `sales_of_product`) VALUES
(1, 'prod1', 4),
(2, 'prod2', 0),
(3, 'prod3', 0),
(4, 'prod4', 0);
...
(1, '1', 'ipallilos_katastimatos_1', '827ccb0eea8a706c4c34a16891f84e7b'),
(2, '2', 'ipallilos_apothikis_1', '827ccb0eea8a706c4c34a16891f84e7b'),
(3, '1', 'ipallilos_katastimatos_2', '827ccb0eea8a706c4c34a16891f84e7b'),
(4, '2', 'ipallilos_apothikis_2', '827ccb0eea8a706c4c34a16891f84e7b');
